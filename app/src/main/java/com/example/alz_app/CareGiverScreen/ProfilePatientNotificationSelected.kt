package com.example.alz_app.LoginScreens.ProfilePatientNotificationSelected
...
@Preview
@Composable
fun PreviewProfileNotificationScreen() {
    NotificationPatientScreen()
}